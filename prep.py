...
def main():
    ...
    args.add_argument('-d', '--dataset',    default='KLSG_Train',   type=str)
    args.add_argument('-s', '--patch_size', default=160,  type=int)
    args.add_argument('-s', '--patch_size', default=160,  type=int)
    args.add_argument('-o', '--overlap',    default=50,  type=int)
    args.add_argument('-a', '--pad_needed', default=False,  type=bool)
    ...
    mp_args = [[data_idx, args.patch_size, args.overlap, args.pad_needed, flag_c, False, flag_n] for data_idx in range(dataset.__len__())]
